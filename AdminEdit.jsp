...
<tr>
<td><input type="text" name="subject" value="<c:out value="${ row.subject}"></c:out>" readonly style="background:lightgray; margin-bottom:20px;"></td>
</tr>
...
<tr>
<td style="color:red; font-size:10px;">no longer than 100 letters</td>
</tr>
...
<tr>
<td style="color:red; font-size:10px;">no longer than 250 letters</td>
</tr>
...
<tr>
<td style="color:red; font-size:10px;">no longer than 1000 letters</td>
</tr>


<tr>
<td><button style="margin-top:20px; color:royalblue">update</button></td>
</tr>
