...
<tr style="border:1px solid gray; border-right:none; border-left:none;">
<td><a href="Controller?page=master-view-article&title=${ row.title}"> <c:out value="${ row.title}"></c:out> </a></td>
<td><c:out value="${ row.user}"></c:out></td>
<td><c:out value="${ row.comment}"></c:out></td>
<td><a href="AdminController?page=master-delete-comments&comment=${ row.comment}">delete</a></td>
</tr>
</c:forEach>
</table>
</div>
